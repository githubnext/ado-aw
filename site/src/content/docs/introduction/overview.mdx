---
title: Overview
description: Learn what ado-aw is, why it exists, and how it makes agentic workflows easier to author
sidebar:
  order: 1
---

`ado-aw` is a compiler that turns natural-language markdown with YAML front matter into Azure DevOps agentic workflow definitions.
