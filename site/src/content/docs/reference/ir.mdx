...
| `AzureCliV3::new(connection, ScriptType, ScriptLocation)` | `AzureCLI@3` | Typed `AzureRm` / `AzureDevOps` connection variants emit mutually exclusive task inputs; used for ADO token acquisition |
