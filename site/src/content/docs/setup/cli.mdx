...
- `-o, --output <dir>` -- local directory for downloaded artifacts and the cached report (default: `${TEMP}/ado-aw/audit`, shared with `ado-aw trace` and the mcp-author tools)
