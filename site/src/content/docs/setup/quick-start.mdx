---
title: Quick Start
description: Get your first ado-aw agentic workflow running in minutes
sidebar:
  order: 1
---
...
The fastest way to create an agentic workflow is to let Copilot do the heavy lifting.
...
1. **Initialize your project**
   ...
   This creates `.github/agents/ado-aw.agent.md` -- a Copilot dispatcher agent that knows how to create, update, and debug agentic workflows. It auto-downloads the `ado-aw` compiler and handles the full lifecycle.
...
2. **Co-create a workflow with Copilot**
   ...
   Describe what you want your agentic workflow to do. For example:
...
1. **Create an agent file**
   ...
   description: A minimal agentic workflow example
   engine:
     id: copilot
