...
4. **Run the pipeline**
   ...
   Back in Azure DevOps, queue your pipeline. It executes the three-stage workflow: Agent → Detection → SafeOutputs.
...
5. **Run the pipeline**
   ...
   Back in Azure DevOps, queue your pipeline. It executes the compiled three-stage workflow: Agent → Detection → SafeOutputs.
