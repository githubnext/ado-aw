...
3. If a finding is genuinely intentional, add a `# shellcheck disable=SCxxxx` comment immediately above the offending line in the bash body. Such directives are bash comments and have no runtime effect.
