...
/// Discovery-capability operations: resource-area lookup and connection
/// negotiation performed before any data call.
...
/// Core-capability operations: project lookup and validation.
...
/// Repos-capability operations: repository, ref, commit, and pull-request
/// read routes.
...
/// Pipelines-capability operations: build/pipeline definition, run, and
/// timeline read routes.
...
/// Boards-capability operations: work-item read, comment, and revision
/// routes.
