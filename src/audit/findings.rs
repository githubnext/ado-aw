...
fn add_ado_proxy_findings(
    ...
    add_ado_proxy_malformed_record_finding(proxy, findings, recommendations);
}

fn add_ado_proxy_unhealthy_lifecycle_finding(
    ...
    if proxy
        .lifecycle
        .as_ref()
        .is_none_or(|lifecycle| lifecycle.healthy_before_teardown)
    {
        return;
    }
...
fn add_ado_proxy_credential_unavailable_finding(
    proxy: &crate::audit::model::AdoProxyAnalysis,
    findings: &mut Vec<Finding>,
    recommendations: &mut Vec<Recommendation>,
) {
...
fn add_ado_proxy_upstream_failed_finding(
    proxy: &crate::audit::model::AdoProxyAnalysis,
    findings: &mut Vec<Finding>,
    recommendations: &mut Vec<Recommendation>,
) {
...
fn add_ado_proxy_out_of_scope_response_finding(
    proxy: &crate::audit::model::AdoProxyAnalysis,
    findings: &mut Vec<Finding>,
    recommendations: &mut Vec<Recommendation>,
) {
...
fn add_ado_proxy_prompt_conflict_finding(
    proxy: &crate::audit::model::AdoProxyAnalysis,
    findings: &mut Vec<Finding>,
    recommendations: &mut Vec<Recommendation>,
) {
...
fn add_ado_proxy_prohibited_request_finding(
    proxy: &crate::audit::model::AdoProxyAnalysis,
    findings: &mut Vec<Finding>,
    recommendations: &mut Vec<Recommendation>,
) {
...
fn add_ado_proxy_malformed_record_finding(
    proxy: &crate::audit::model::AdoProxyAnalysis,
    findings: &mut Vec<Finding>,
    recommendations: &mut Vec<Recommendation>,
) {
