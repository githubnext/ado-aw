...
│           ├── compiler-smoke-e2e/ # Compiler-candidate smoke E2E orchestrator (not a bundle; stages candidate across 5 fixture pipelines on mirror repo and asserts green; built to test-bin/compiler-smoke-e2e.js)
