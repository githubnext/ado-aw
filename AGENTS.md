...
│           ├── trigger-e2e/ # Test-only: FACT_META gate-spec table + trigger-evaluation E2E scenarios (not a bundle; used as drift guard between Rust Fact::ALL and TypeScript FACT_META via export-fact-catalog)
