...
│           ├── trigger-e2e/ # Trigger-condition (gate / synth-PR) E2E test harness (not a bundle; runs deterministic scenarios against a real ADO project; fact-catalog.gen.json drift guard for Rust Fact registry vs TypeScript FACT_META)
