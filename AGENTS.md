...
│   ├── prompt-evals/     # Dependency-free Node harness for paired PR prompt evaluations, nightly scorecards, artifact history, trend alerts, and report rendering
...
│   └── prompt-evals/     # Versioned synthetic create/update/debug cases, context, ground truth, and scoring rubrics
...
- [`docs/prompt-evals.md`](docs/prompt-evals.md) — deterministic prompt
  contracts plus paired PR evaluation, nightly synthetic trends, sustained
  regression alerts, artifacts, and rolling Discussion reports.
