...
│           ├── trigger-e2e/ # test-only: FACT_META gate-spec table + trigger-evaluation E2E scenarios (not a bundle); drift-guarded by `export-fact-catalog` + `fact-catalog.gen.json`; see `docs/ado-script.md`
