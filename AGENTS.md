...
│           ├── trigger-e2e/ # Trigger-condition E2E test harness (not a bundle; crafts GateSpec/PrSynthSpec inputs and validates filter evaluation; has own __tests__/ subdirectory; synced with Rust Fact registry via fact-catalog.gen.json)
