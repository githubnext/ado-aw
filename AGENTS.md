...
│           ├── compiler-smoke-e2e/ # TypeScript E2E orchestrator for compiler smoke tests (not a bundle; stages the compiler candidate across 5 real fixtures, queues candidate-lane definitions, and asserts all go green; test harness only, not shipped in ado-script.zip)
