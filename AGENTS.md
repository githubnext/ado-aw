...
│           ├── compiler-smoke-e2e/ # CI compiler smoke-test harness (not a bundle; stages the compiler candidate via supply-chain.pipeline-artifact across 5 fixtures, pushes to a short-lived mirror branch, queues the candidate-lane pipelines, and asserts they all go green)
