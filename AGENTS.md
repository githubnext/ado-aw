...
│   │   │   ├── container_runtime.rs # Typed Docker runtime configuration (Mount/MountMode, Network, Tmpfs, ContainerUser, AddHost) shared by MCPG stdio servers and runtime extensions (e.g. Lean)
