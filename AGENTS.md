...
│           ├── compiler-smoke-e2e/ # Compiler smoke E2E harness (not a bundle; drives tests/compiler-smoke-e2e/ — recompiles fixtures against the in-tree compiler, queues ADO runs, and asserts pipeline shape)
