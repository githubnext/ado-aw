...
│           ├── trigger-e2e/ # Test-only: FACT_META gate-spec mirror (`gate-spec.ts`) + trigger-evaluation E2E scenarios; drift-guarded by `export-fact-catalog` → `fact-catalog.gen.json`; not a bundle
