...
│           ├── trigger-e2e/ # Trigger-condition E2E harness (not a bundle; TypeScript port of the Rust GateSpec/PrSynthSpec builders; includes fact-catalog.gen.json drift-guard synced by `export-fact-catalog`)
