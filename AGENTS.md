...
│           ├── trigger-e2e/ # Test-only trigger-condition E2E harness (not a bundle); FACT_META gate-spec table + trigger-evaluation E2E scenarios; drift-guarded by `export-fact-catalog`
