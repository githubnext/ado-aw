...
│           ├── trigger-e2e/ # Gate/filter E2E test harness: `gate-spec.ts` (`FACT_META` mirror) + `fact-catalog.gen.json` (generated by `export-fact-catalog`); `gate-spec.test.ts` deep-compares `FACT_META` against the Rust-generated catalog as a drift guard
