...
│           ├── trigger-e2e/ # Gate/synth-PR trigger-condition E2E harness (not a bundle; contains FACT_META gate-spec table + trigger-evaluation scenarios; `__tests__/` subdirectory holds the `gate-spec.test.ts` CI drift guard)
