...
│           ├── trigger-e2e/ # test-only: FACT_META gate-spec table + trigger-evaluation E2E scenarios (not a bundle; fact-catalog.gen.json written here by `export-fact-catalog`)
