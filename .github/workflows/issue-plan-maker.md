...
4. When repository context is insufficient, use web search to validate external facts, APIs, version behavior, or best practices, but only if the web-search tool is available at runtime.
