...
# permissions-required:          # optional: abstract read/write requirements unioned across
#   read: true                   # this workflow and its imports; validated against the
#   write: true                  # concrete `permissions:` above (see docs/imports.md#permissions-required)
